...
##convert v1 to date/time and v7 through v9 as numeric

UCmachine <- UCmachine %>% mutate(V1 = as.POSIXct(dmy_hms(as.character(paste(V1, V2)))),
V7 = as.numeric(as.character(V7)),V8 = as.numeric(as.character(V8)),V9 = as.numeric(as.character(V9))) %>% select(V1,V7:V9)
##Make a plot
